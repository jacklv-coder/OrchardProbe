...
predates the required `container_kind` field. An exact-digest compatibility
remediation must pass review and merge before another fresh acknowledgement and
signed one-shot envelope may immediately precede installation enrollment. A separate fresh
