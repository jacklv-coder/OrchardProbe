...
|---:|---|---|---|
| 1 | Activation and closed layout design | `active when the activation PR merges` | Issue #84, this bilingual contract, and the execution-ledger insertion are on `main` |
