...
implementation checkpoints through PR #59. Checkpoint 3 produced exactly one
...
both retained artifacts still matched inode, mode, size, and SHA-256. An
exact-frozen-tuple coupled-rebind remediation is active; another fresh
acknowledgement is required only after it merges.
