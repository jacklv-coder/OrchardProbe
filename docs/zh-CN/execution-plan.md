...
| 9 | `HOST-008` | `active` | 把不可变源 IPA 物化到私有、有界的工作目录，阻止 Symlink/Path Escape，排除 Receipt 和 `SC_Info`，不修改源文件。 | `HOST-007` | [#37](https://github.com/jacklv-coder/OrchardProbe/issues/37) | 待填写激活 PR | — |
